...
exports.findOneDocumentAbogadoCliente = (req,res) => {

  let conditions = { abogado_id: req.params.abogado_id, cliente: req.params.cliente };
...
exports.findOneDocumentAbogadoCliente = (req,res) => {
  ...
  let conditions = { abogado_id: req.params.abogado_id, cliente_id: req.params.id };
